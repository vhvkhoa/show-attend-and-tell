...
def main():
    ...
    solver = CaptioningSolver(model, data, val_data, n_epochs=20, batch_size=128, update_rule='rmsprop',
                                    learning_rate=0.0001, print_every=10, eval_every=200, save_every=200, image_path='./image/',
